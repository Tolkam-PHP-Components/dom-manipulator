...
{
    /**
     * @covers Manipulator::__construct
     * @covers Manipulator::filter
     * @covers Manipulator::getFirstNode
     * @covers Manipulator::nodeName
     */
    public function testInstance()
    {
        ...
        $this->assertInstanceOf(Manipulator::class, $title);
        $this->assertInstanceOf(DOMNode::class, $title->getNode(0));
        $this->assertEquals('h1', $title->nodeName());
    }
    
    /**
     * @covers Manipulator::setInnerHtml
     * @covers Manipulator::prepend
     * @covers Manipulator::makeEmpty
     * @covers Manipulator::setAttribute
     */
    ...
    /**
     * @covers Manipulator::isHtmlDocument
     */
    public function testIsHtmlDocument()
    {
        ...
        $c = new Manipulator('<html><body><div id="content"><h1>Title</h1></div></body></html>');
        $this->assertTrue($c->isHtmlDocument());
    }
    
    /**
     * @covers Manipulator::saveHTML
     */
    ...
    /**
     * @covers Manipulator::css
     * @covers Manipulator::getStyle
     * @covers Manipulator::setStyle
     */
    public function testCss()
    {
        ...
        $this->assertEquals('1px solid red', $t->getStyle('border-bottom'));
    ...
    /**
     * @covers Manipulator::addClass
     * @covers Manipulator::removeClass
     * @covers Manipulator::hasClass
     */
    public function testClasses()
    {
        ...
        $c1 = new Manipulator('<p class="a"></p><p class="b"></p><p class="c"></p>');
        $this->assertTrue($c1->hasClass('b'));
    }
    
    /**
     * @covers Manipulator::addContent
     */
    ...
    /**
     * @covers Manipulator::insertBefore
     */
    ...
    /**
     * @covers Manipulator::insertAfter
     */
    ...
    /**
     * @covers Manipulator::replaceWith
     */
    ...
    public function testUnwrapInnerOnDOMElementExeption()
    {
        ...
        $c = Manipulator::create('<div id="content"></div>');
    ...
    /**
     * @covers Manipulator::unwrapInner
     */
    ...
    /**
     * @covers Manipulator::toggleClass
     */
...
END;
    ...
    {
        $this->expectException(InvalidArgumentException::class);
        $c = Manipulator::create(null);
        $c->attr('data-foo');
    }
    
    public function testSetInnerHtml()
    {
        $html = Manipulator::create('<h1>Title</h1>');
        $this->assertInstanceOf(Manipulator::class, $html->setInnerHtml('<h2>Title</h2>'));
    ...
    {
        $html = Manipulator::create('<h2>Title</h2>');
    ...
    public function testReturnValues()
    {
        ...
        $c1 = Manipulator::create('<h1>Headline</h1>');
        $c2 = Manipulator::create('<p>1</p><p>2</p><p>3</p>');
        $c3 = Manipulator::create('<span>asdf</span>');
    ...
    public function testDisconnectedNodes()
    {
        ...
        $c = Manipulator::create('<div>abc</div>');
        $r = Manipulator::create('<div>def</div>');
    ...
    {
        $c = Manipulator::create('<div><p class="x">asdf</p></div>');
        $p = $c->filter('p');
